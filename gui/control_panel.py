"""
Control panel widget for Campus Navigator.
Contains dropdowns, buttons, and result display.
"""
...
class ControlPanel(QWidget):
    """Control panel for selecting locations and displaying results."""
    ...
    def display_result(self, eta_text: str, path_text: str) -> None:
        ...
        self.eta_label.setStyleSheet(f"color: rgb{config.COLOR_TEXT_SUCCESS};")

        self.path_label.setText(path_text)
        self.path_label.setStyleSheet(f"color: rgb{config.COLOR_TEXT_NORMAL};")
